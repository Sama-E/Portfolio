...
const Testimonials = () => {
    ...
    return (
        <section id="testimonials" className="pt-16 pb-24">
            {/* HEADING */}
            <motion.div
            ...
            <div className="md:flex md:justify-between gap-8">
                ...
                >
                    <p className="font-playfair text-6xl">"</p>
                    <p>
                        Aliquam, amet dui feugiat facilisi dui.Aliquam, amet dui feugiat facilisi dui.
                    </p>
                </motion.div>
                <motion.div
                ...
                >
                    <p className="font-playfair text-6xl">"</p>
                    <p>
                        Aliquam, amet dui feugiat facilisi dui.Aliquam, amet dui feugiat facilisi dui.Aliquam, amet dui feugiat facilisi dui.
                    </p>
                </motion.div>
